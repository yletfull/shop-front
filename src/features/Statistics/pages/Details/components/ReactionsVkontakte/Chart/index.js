...
const ReactionsVkontakteChart = function ReactionsVkontakteChart({
  data,
  dateStart,
  dateEnd,
}) {
...
ReactionsVkontakteChart.propTypes = propTypes;
ReactionsVkontakteChart.defaultProps = defaultProps;

export default ReactionsVkontakteChart;
