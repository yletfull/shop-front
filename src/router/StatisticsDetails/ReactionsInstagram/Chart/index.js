...
const ReactionsInstagramChart = function ReactionsInstagramChart({
  data,
  dateStart,
  dateEnd,
}) {
...
ReactionsInstagramChart.propTypes = propTypes;
ReactionsInstagramChart.defaultProps = defaultProps;

export default ReactionsInstagramChart;
